...
var $0d92898c5258141f$exports = {};


(parcelRequire("8SF9g")).register((parcelRequire("71vaS")).getBundleURL('jcyqO'), JSON.parse("[\"jcyqO\",\"index.js\",\"ethBj\",\"dynamic-import-await-destruct.a2ffda3d.js\"]"));

// index.js
var $ade785944ad51d9b$exports = {};


$ade785944ad51d9b$exports = (parcelRequire("3y4Sl"))((parcelRequire("8SF9g")).resolve("ethBj")).then(()=>parcelRequire('84NNf'));


const { bar: $cb5ed5e99f561d89$var$bar } = await $ade785944ad51d9b$exports;
