...
parcelRegister("6b8Wn", function(module, exports) {


module.exports = (parcelRequire("3y4Sl"))((parcelRequire("8SF9g")).resolve("4MQSM")).then(()=>parcelRequire('lG7SI'));
...
var $7e5ce5746e46764a$exports = {};


(parcelRequire("8SF9g")).register((parcelRequire("71vaS")).getBundleURL('ayALj'), JSON.parse("[\"ayALj\",\"index.js\",\"4MQSM\",\"promise-then-destruct.7898c7b0.js\"]"));

// index.js

(parcelRequire("6b8Wn")).then(({ foo: foo })=>{
    console.log(`foo: `, foo);
});
