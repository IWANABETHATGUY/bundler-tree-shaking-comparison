...
parcelRegister("estgw", function(module, exports) {


module.exports = (parcelRequire("iZcSh"))((parcelRequire("33tOP")).resolve("4MQSM")).then(()=>parcelRequire('lG7SI'));
...
var $c0abfd053e8de874$exports = {};


(parcelRequire("33tOP")).register((parcelRequire("018qO")).getBundleURL('ayALj'), JSON.parse("[\"ayALj\",\"index.js\",\"4MQSM\",\"promise-then-destruct.7898c7b0.js\"]"));

// index.js

(parcelRequire("estgw")).then(({ foo: foo })=>{
    console.log(`foo: `, foo);
});
